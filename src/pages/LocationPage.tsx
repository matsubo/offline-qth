...
export function LocationPage() {
  ...
  const pageDescription = `${location.city}(${location.prefecture})のJCC番号は${location.jcc}、JCG番号は${location.jcg}です。位置情報、グリッドロケーター情報を掲載。オフライン対応。`
              ...
              <div className="space-y-4 text-gray-300 font-sans-clean">
                ...
                <section>
                  ...
                  <p>
                    ...
                    to access JCC/JCG information even without internet connection during field operations.
                  </p>
                </section>
              </div>
            </div>
